function Projects() {
  ...
  return (
    <section className="container pt-5 mt-4  pb-2" id="projects">
      <h2 className="text-center">My Work & Projects</h2>
        ...
        <div className="row mt-4 project_cards gap-md-3 gap-3 ">
          <div className="col-md-3 card card-body p-4">
              ...
              <a style={project_libk} class="text-white text-decoration-dashed" href="https://billite.co/" target="_blank">View Project</a>
          </div>
          <div className="col-md-3 card card-body p-4">
              ...
              <a style={project_libk} class="text-white text-decoration-dashed" href="https://akshayachaitanya.org/" target="_blank">View Project</a>
          </div>
          <div className="col-md-3 card card-body p-4">
              ...
              <a style={project_libk} class="text-white text-decoration-dashed" href="https://allthingsecommerce.co/" target="_blank">View Project</a>
            </div>
           <div className="col-md-3 card card-body p-4">
              ...
              <a style={project_libk} class="text-white text-decoration-dashed" href="https://reynlab.com/" target="_blank">View Project</a>
            </div>
          <div className="col-md-3 card card-body p-4">
              ...
              <a style={project_libk} class="text-white text-decoration-dashed" href="https://theprismacademy.in/" target="_blank">View Project</a>
            </div>
          <div className="col-md-3 card card-body p-4">
              ...
              <a style={project_libk} class="text-white text-decoration-dashed" href="https://staccato.in/" target="_blank">View Project</a>
            </div>
